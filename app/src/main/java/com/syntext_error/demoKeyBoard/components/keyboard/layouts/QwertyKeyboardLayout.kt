package com.syntext_error.demoKeyBoard.components.keyboard.layouts
...
import com.syntext_error.demoKeyBoard.components.keyboard.KeyboardListener
...
//        rowFour.add(createButton("XX", columnWidth, 'x'))
...
//            200
//        )
//        var llTestMenuMain = LinearLayout(context)
//        llTestMenuMain.layoutParams = params
//        llTestMenuMain.setBackgroundColor(Color.RED)
//
//       rows.add(llTestMenuMain)
    ...
    private  fun createGIFROW():LinearLayout{
        val row = ArrayList<View>()
        row.add(createButton("GIF",
            0.3f, KeyboardController.SpecialKey.GIF))
     //  row.add(createButton("GIF", columnWidth, KeyboardController.SpecialKey.GIF))
        return  createRow(row)
    }
